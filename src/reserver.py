...
class Reserver:
    def __init__(self, session):
        ...
        self.reserve_url = (
            "http://libzwxt.ahnu.edu.cn/SeatWx/ajaxpro/SeatManage.Seat,SeatManage.ashx"
        )
        self.headers = {
    ...
    def _choose_time(self, date_offset, start_time, end_time):
    ...
    def _reserve_seat(self, seat_code, date, start_time, end_time):
        ...
        try:
            response = self.session.post(
                url=self.reserve_url, headers=self.headers, data=data, verify=False
            )
    ...
    def reserve(self, seat_code, date_offset, start_time, end_time):
        date, start, end = self._choose_time(date_offset, start_time, end_time)
